...
process capsule_inference {
	...
	ln -s ${launchDir}/input/frame_range/$path2 capsule/data/List_of_frames_intervals/input_range.json
...
process capsule_finetuning_allen {
	...
	ln -s '${launchDir}/input/2021_07_31_09_49_38_095550_unet_1024_search_mean_squared_error_pre_30_post_30_feat_32_power_1_depth_4_unet_True-0125-0.5732.h5' capsule/data/deepInterpolation_input_model.h5
...
process capsule_download_allen {
	...
	ln -s '${launchDir}/input/movie_s3/$path7' ./capsule/data/movie_param.json
